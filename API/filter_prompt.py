...
def get_filter_prompt(currentFilters):
    ...
    f"airlines: Filters specific airline carriers. Valid return value is a complete object with all airlines from 'currentFilters.airlines', changing each field to true or false based on the user message. When excluding airlines, set them to false. When including airlines, set them to true and all others to false. Examples: [airlines, '{{American: false, Delta: true, JetBlue: true, United: true, Spirit: true, ...}}']\n"
    ...
    f"Important Note 3: For airline filters, always provide a complete object with all airlines from currentFilters.airlines, updating their values based on the user's request. Do not use ellipsis (...) in the response.\n\n"

    # Example Responses
    f"Example Responses:\n"
    f"UserMessage: Only show non-stop flights, YourResponse: [stops, 0]\n"
    f"UserMessage: Don't show JetBlue or American flights, YourResponse: [airlines, '{{American: false, Delta: true, JetBlue: false, United: true, Spirit: true, Frontier: true, Alaska: true, \"Multiple Airlines\": true}}']\n"
    f"UserMessage: Only show Delta and United flights, YourResponse: [airlines, '{{American: false, Delta: true, JetBlue: false, United: true, Spirit: false, Frontier: false, Alaska: false, \"Multiple Airlines\": false}}']\n"
    f"UserMessage: Exclude all airlines except Southwest, YourResponse: [airlines, '{{American: false, Delta: false, JetBlue: false, United: false, Spirit: false, Frontier: false, Alaska: false, \"Multiple Airlines\": false, Southwest: true}}']\n"
    f"UserMessage: Include all airlines, YourResponse: [airlines, '{{American: true, Delta: true, JetBlue: true, United: true, Spirit: true, Frontier: true, Alaska: true, \"Multiple Airlines\": true}}']\n"
    ...
    f"UserMessage: Only show non-stop flights that are not Spirit Airlines and cost less than 300, YourResponse: [stops, 0, airlines, '{{American: true, Delta: true, JetBlue: true, United: true, Spirit: false, Frontier: true, Alaska: true, \"Multiple Airlines\": true}}', price, 300]\n"
